...
namespace DemoApp
{
    public class GroupingDesignerItemViewModel : DesignerItemViewModelBase, IDiagramViewModel
    {
        ...
        public GroupingDesignerItemViewModel(string id, IDiagramViewModel parent, double left, double top)
        ...
        public GroupingDesignerItemViewModel(string id, IDiagramViewModel parent, double left, double top, double itemWidth, double itemHeight) : base(id, parent, left, top, itemWidth, itemHeight)
        {
            Init();
        }
