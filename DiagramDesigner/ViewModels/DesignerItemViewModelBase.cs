...
namespace DiagramDesigner
{
    ...
    public abstract class DesignerItemViewModelBase : SelectableDesignerItemViewModelBase
    {
        ...
        public DesignerItemViewModelBase(string id, IDiagramViewModel parent, double left, double top) : base(id, parent)
        {
            this.left = left;
            this.top = top;
            Init();
        ...
        public DesignerItemViewModelBase(string id, IDiagramViewModel parent, double left, double top, double itemWidth, double itemHeight) : base(id, parent)
        {
            this.left = left;
            this.top = top;
